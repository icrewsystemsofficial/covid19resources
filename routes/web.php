...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => ['role:superadmin|moderator']], function () {
            ...
            Route::post('/resources/import', [ResourceController::class, 'import'])->name('admin.resources.import.file');
            Route::get('/resources/import/new', [ResourceController::class, 'admin_import'])->name('admin.resources.import');
            Route::get('/resources/export', [ResourceController::class, 'admin_resource_importsample'])->name('admin.resources.exportsample');
            ...
            Route::prefix('mission')->group(function () {
                ...
                Route::post('/update/{uuid}', [MissionAdmin::class, 'update'])->name('admin.mission.update');
