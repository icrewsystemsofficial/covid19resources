    ...
    <div class="page-inner mt--5">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="{{ route('home.search.results') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="text-warning">
                                                Resource <i class="fas fa-database"></i>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('home.view', $result->id) }}"
                                               class="btn btn-success btn-sm" target="_blank">View Resource</a>
                                            ...
                                            <a href="{{ route('admin.resources.manage', $result->id) }}"
                                               class="btn btn-primary btn-sm" target="_blank">Manage Resource</a>
