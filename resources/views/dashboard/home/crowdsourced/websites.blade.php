...
["Twitter Search for COVID","<a type='button' class='btn btn-primary' href='https://covid19-twitter.in'>Vist site</a>"],
    ...
    ["Plasma Donor","<a type='button' class='btn btn-primary' href='https://plasmadonor.in'>Vist site</a>"],
    ...
    ["Resource Portal for Pan India Resources","<a type='button' class='btn btn-primary' href='https://covidfacts.in'>Vist site</a>"],
    ["Life | Corona Safe - Resource Portal for Pan India Resources ","<a type='button' class='btn btn-primary' href='https://liferesources.in/'>Vist site</a>"],
