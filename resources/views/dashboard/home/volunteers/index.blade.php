...
<div class="page-inner">
    <div class="page-header mt-2">
        <h4 class="page-title">Volunteer Dashboard</h4>
    </div>
    <p class="mb-4">
        This website depends heavily on human volunteers to <strong>verify</strong> the data we gather
        from Twitter & other sources. Your help goes a long way, and will reflect in the lives of people who've recovered from this battle using our help.
    </p>
        ...
        <div class="col-md-12">
            <p>
                ...
                <button class="btn btn-primary mb-4" type="button" data-toggle="collapse" data-target="#SOPBox" aria-expanded="false" aria-controls="SOPBox">
                    <abbr title="Standard Operating Procedures">SOP</abbr> for <strong>verifying</strong> resources. (Must read)
                </button>
              </p>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage tweets <span class="badge badge-primary">{{ count($tweets) }}</span></h4>
                </div>
                <div class="card-body">
