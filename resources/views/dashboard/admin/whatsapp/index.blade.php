...
<div class="page-inner">
    ...
    <p>
        This is a collection of the latest information regarding the resources obtained from Whatsapp.
    </p>
    <div class="row">
        <div class="col-md-12">
            <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage resources from whatsapp <span class="badge badge-primary">{{ count($resources) }}</span></h4>
