    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.categories.update', $resource->id) }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="desc" cols="30" rows="10">{{ $resource->description }}</textarea>
                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="1" class="selectgroup-input" <?php if($resource->status == 1) { echo "checked"; } ?>>
                                            <span class="selectgroup-button">Publish</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="0" class="selectgroup-input" <?php if($resource->status == 0) { echo "checked"; } ?>>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('admin.categories.delete', $resource->id) }}" onclick="return confirm('Are you sure you wish to delete this resource? This action cannot be undone');" class="btn btn-danger btn-md">Delete</a>
