...
<div class="page-inner">
    <div class="page-header mt-4">
        <a href="{{ route('admin.mission.index') }}" class="btn btn-warning btn-sm mr-3">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.mission.update', $mission->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" required value="{{ $mission->title }}" />
                        </div>

                        <div class="form-group">
                            <label for="description"><strong>Body</strong></label>
                            <textarea class="form-control" name="description" id="desc" cols="30" rows="10">{{ $mission->description }}</textarea>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('admin.mission.delete', $faq->id) }}" onclick="return confirm('Are you sure you wish to delete this FAQ? This action cannot be undone');" class="btn btn-danger btn-md">Delete</a>
