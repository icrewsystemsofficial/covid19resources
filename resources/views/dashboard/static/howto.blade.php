        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>1. How to add Resources?</strong>
                        </h1>
                            <ul class="ml-3">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>2. How to add Geographical Data?</strong>
                        </h1>
                        For Cities - 
                        <ul class="ml-3">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>3. How to access various Resource Categories (Oxygen/Ventilators etc..)</strong>
                        </h1>
                        <ul class="ml-3">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>4. How to retreive data from Twitter? </strong>
                        </h1>
                        <ul class="ml-3">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>5. How do I view/track my activities on this website?</strong>
                        </h1>
                        <ul class="ml-3">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>6. How do I access other users (admins/volunteers etc..) details? </strong>
                        </h1>
                        <ul class="ml-3">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>7. How do I create / view / manage FAQ's ? </strong>
                        </h1>
                        <ul class="ml-3">
                    ...
                    <p class="mb-3">
                        <h1 class="h2">
                            <strong>8. How do I create / view / manage user roles? </strong>
                        </h1>
                        <ul class="ml-3">
