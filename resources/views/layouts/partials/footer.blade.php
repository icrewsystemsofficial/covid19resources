                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <!-- Sharingbutton Facebook -->
                            <a class="resp-sharing-button__link text-white" style="text-decoration:none" href="https://facebook.com/sharer/sharer.php?u={{ url()->current() }}" target="_blank" rel="noopener" aria-label="Share on Facebook">
                              ...
                              <a class="resp-sharing-button__link text-white" style="text-decoration:none" href="https://twitter.com/intent/tweet/?text=verified resources for covid-19&amp;url={{ url()->current() }}" target="_blank" rel="noopener" aria-label="Share on Twitter">
                              ...
                              <a class="resp-sharing-button__link text-white" style="text-decoration:none" href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{ url()->current() }}&amp;title=verified resources for covid-19&amp;summary=verified resources for covid-19&amp;source={{ url()->current() }}" target="_blank" rel="noopener" aria-label="Share on LinkedIn">
                              ...
                              <a class="resp-sharing-button__link text-white" style="text-decoration:none" href="whatsapp://send?text=verified resources for covid-19%20{{ url()->current() }}" target="_blank" rel="noopener" aria-label="Share on WhatsApp">
